...
namespace lab_49_MVC_core_users_categories_ToDoItems.Controllers
{
    ...
    {
        private readonly ToDoItemsModel _context;

        public ToDoItemsController(ToDoItemsModel context)
        {
            _context = context;
        }
        ...
        {
            var toDoItemsModel = _context.ToDoItems.Include(t => t.Category).Include(t => t.User);
            return View(await toDoItemsModel.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ToDoItemId,Item,DateDue,Done,CategoryId,UserId")] ToDoItem toDoItem)
        {
